...
namespace SF.Framework.Mvc.Pager
{
    ...
    internal class PagerBuilder
    {
        ...
        private void AddFirst(ICollection<PagerItem> results)
        {
            ...
            //Only navigation button is not disable, or navigation button is disabled but ShowDisabledButtoms = true to add
            if (!item.Disabled || (item.Disabled && _pagerOptions.ShowDisabledPagerItems))
                results.Add(item);
        }
        ...
        /// <summary>
        /// According to the index page generated page navigation Url
        /// </summary>
        /// <param name="pageIndex">To create navigation links page index</param>
        /// <returns>Page navigation links:Url</returns>
        private string GenerateUrl(int pageIndex)
        {
            //If you want to generate url page index less than 1 or greater than the total number of pages or equal to the current page index, without generating page navigation links
            ...
            // Set the page navigation Route Value Url parameter Value, pageIndex is 0 generation is applicable to the script navigation links
            if (pageIndex == 0)
        ...
        /// <summary>
        /// Generate the final page Html code
        /// </summary>
        /// <returns></returns>
