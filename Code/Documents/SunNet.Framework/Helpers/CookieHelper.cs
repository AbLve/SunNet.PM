...
namespace SF.Framework.Helpers
{
    public static class CookieHelper
    {
        ...
        #region Add Cookie
        private static void Add(string key, string value, int slidingMinutes, string domainName, string path)
        {
            CheckKey(key);
            CheckValue(value);
        ...
        public static void Add(string key, string value, DateTime expirationDate)
        {
            CheckKey(key);
            CheckValue(value);
