...
namespace SunNet.PMNew.Framework.Core.BrokenMessage
{
    public class BrokenMessageEnabled
    {
        ...
        public void AddBrokenRuleMessage()
        {
            BrokenRuleMessage rm = new BrokenRuleMessage("The system is wrong", "Please feedback to Administrator.");
        ...
        public string FirstBrokenRuleMessageContent
        {
            get
            {
                if (FirstBrokenRuleMessage != null)
                    return FirstBrokenRuleMessage.Message;
                return null;
            }
        }
