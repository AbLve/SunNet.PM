...
{
    public partial class Survey : GlobalPage
    {
        ...
        private void GetInformation()
        {
            ...
            if (content != string.Empty)
            {
                ...
                {
                    this.ShowFailMessageToClient(" Please select.");
                    this.survey1.Focus();
                    return;
                }
                ...
                else
                {
                    ...
                    {
                        this.ShowFailMessageToClient(" SendFail.");
                    }
                }
            }
        ...
        private bool Validata(string str)
        {
            ...
            {
                ShowFailMessageToClient(" Please select.");
                return true;
            }
            else
                return false;
