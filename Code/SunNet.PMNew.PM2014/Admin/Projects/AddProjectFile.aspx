<%@ Page Title="" Language="C#" MasterPageFile="~/Pop.master" AutoEventWireup="true" CodeBehind="AddProjectFile.aspx.cs" Inherits="SunNet.PMNew.PM2014.Admin.Projects.AddProjectFile" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bodySection" runat="server">   
    <div class="form-group">
        ...
        <div class="col-right-fddeny righttext">
            <asp:TextBox ID="txtFileTitle" runat="server" MaxLength="500" CssClass="inputw5 required"></asp:TextBox>
        </div>
    </div>
    <div class="form-group">
