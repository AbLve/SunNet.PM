<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pop.master"
    CodeBehind="NewCompany.aspx.cs" Inherits="SunNet.PMNew.PM2014.Admin.NewCompany" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodySection" runat="server">
    <div class="form-group">
        ...
        <div class="col-right-profile1 righttext">
            <asp:TextBox ID="txtCompanyName" Validation="true" MaxLength="200" runat="server"
        ...
        <div class="col-right-profile1 righttext">
            <asp:TextBox ID="txtAddress1" TabIndex="2" Validation="true" MaxLength="500" runat="server" CssClass="inputProfle1 required"></asp:TextBox>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-right-profile1 righttext">
            ...
            <asp:TextBox ID="txtFax"   TabIndex="5" ValidatorTitle="The Fax number field cannot be left blank."
                RegType="fax" MaxLength="20" runat="server" CssClass="inputProfle1 phone required"></asp:TextBox>
        </div>
