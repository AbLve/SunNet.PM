<%@ Page Title="" Language="C#" MasterPageFile="~/SunnetTicket/Sunnet.master" AutoEventWireup="true" CodeBehind="ClientProject.aspx.cs" Inherits="SunNet.PMNew.PM2014.SunnetTicket.ClientProject" %>
    ...
    <script type="text/javascript">
        ...
        function ProjectViewModel() {
            ...
            this.refresh = function () {
                $.getJSON("/Service/Project.ashx", { action: "getclientproject", userid: currentUserId }, function (data) {
                    self.otherDataset([]);
                    self.dataset([]);
