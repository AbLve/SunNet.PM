...
var $queue = $('<ul class="filelist"></ul>').appendTo($('#uploader').find('div.queueList')); //图片容器
...
var SunnetWebUploader = {
    ...
    setFileViewContent: function (file) {
        var $li = $('<li id="' + file.id + '">' +
                '<p class="title">' + file.name + '</p>' +
                '<p class="imgWrap"></p>' +
                '<p class="progress"><span></span></p>' +
                '</li>'),
            $btns = $('<div class="file-panel"><span class="cancel">Delete</span></div>').appendTo($li),
        ...
        if (file.getStatus() === 'invalid') {
            ...
            // @todo lazyload
            $wrap.text('In process of preview.');
            ...
            uploader.makeThumb(file, function (error, src) {
                ...
                var img = $('<img title="' + file.name + '" src="' + src + '">');
        ...
        file.on('statuschange', function (cur, prev) {
            ...
            if (cur === 'error' || cur === 'invalid') {
                ...
                $("div.mainrightBox #" + file.id).remove();
    ...
    CreateWebUploader: function (options) {
        ...
        uploader.on('fileQueued', function (file) {
            ...
            SunnetWebUploader.setFileViewContent(file);
        });
