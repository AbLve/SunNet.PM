<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClientMaintenancePlan.ascx.cs" Inherits="SunNet.PMNew.PM2014.UserControls.Admin.ClientMaintenancePlan" %>
<table>
    <tr>
        <td id="tdOptions">
        ...
        <td style="vertical-align: top;">
            <div id="dvPlan" name="dvPlan" style="display: none;">
                <span style="margin-left: 40px;">
                    <label>
                        Total Hours</label><span class="noticeRed">*&nbsp;</span>
                    <asp:TextBox runat="server" ID="txtTotalHours" Width="68" onkeyup="FormatNumber(this, 500)"
                                        onblur="FormatNumber(this, 500)" ></asp:TextBox>
