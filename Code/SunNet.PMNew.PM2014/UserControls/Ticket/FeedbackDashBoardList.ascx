<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FeedbackDashBoardList.ascx.cs" Inherits="SunNet.PMNew.PM2014.UserControls.Ticket.FeedbackDashBoardList" %>
...
<div class="feedbackBox" id="feedbackBox">
    ...
    <div style="height: 350px; overflow-x: hidden; overflow-y: scroll" id="fbScroll">
        <ul class="fdItembox">
...
<div id="Div1" class="chat_input_box" runat="server">
    ...
    <span class="chat_btns_p"><a class="chat_btn_push">
        <asp:ImageButton ID="btnSubmit" runat="server" ImageUrl="/Images/chat_push_icon.png" PostBackUrl="#"
            OnClientClick="return beforeSubmit(this);" Style="left: 0px; position: relative; top: 15px; border: 0px" />
            ...
            $.ajax({
                ...
                if (message && message.success) {
                    ...
                    if (message.data && message.data.extraStatus && message.data.extraStatus.clearClient) {
                        jQuery("#chkClient<%=UserInfo.ID%>").parent().removeClass("feedback_waiting").addClass("feedback_writed");
                    }
