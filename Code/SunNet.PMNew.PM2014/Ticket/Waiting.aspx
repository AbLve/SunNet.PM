<%@ Page Title="Waiting for Response" Language="C#" MasterPageFile="~/Ticket/Client.master" AutoEventWireup="true" CodeBehind="Waiting.aspx.cs" Inherits="SunNet.PMNew.PM2014.Ticket.Waitting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script id="temp_ticketStatus_desc" type="text/html">
        <div class="faqsText" id="div7">
            ...
            <p>
                <strong class="faqsspantext1">Ready For Review </strong>- <u>Denied</u> definitions
            </p>
        </div>
    </script>
