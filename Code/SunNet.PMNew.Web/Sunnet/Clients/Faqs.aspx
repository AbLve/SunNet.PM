<%@ Page Title="Faqs" Language="C#" MasterPageFile="~/Sunnet/Main.Master" AutoEventWireup="true"
                ...
                <tbody>
                    <tr>
                        <td width="100%" class="faqsBottom">
                            <div class="faqsTitle">
                                1. How can I create a new user?</div>
                            <div class="faqsText" id="div1">
                                To create a new user, please visit <a href="http://client.sunnet.us">http://client.sunnet.us</a>
                                and select the ‘Create a new account’ option located under the Login button.</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                2. How do I submit a bug?</div>
                            <div class="faqsText" id="div2">
                                ...
                                status until completion.</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                3. How do I submit a new request?</div>
                            <div class="faqsText" id="div3">
                                ...
                                ticket’s status until completion.</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                4. I have multiple tickets entered. How can I sort through the tickets?</div>
                            <div class="faqsText" id="div4">
                                ...
                                Created by and Action.’</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                5. How will I know when there are updates to my ticket?</div>
                            <div class="faqsText" id="div5">
                                ...
                                <p class="faqsspantext">
                                    ...
                                    For more information, log into the client portal. <a href="http://client.sunnet.us">
                                        http://client.sunnet.us</a></p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                6. What does the ticket status mean?</div>
                            <div class="faqsText" id="div7">
                                <p>
                                    <strong class="faqsspantext1">Draft </strong>- <u>Draft</u> stands for that you
                                    have just write a draft,it has not entered into the system.</p>
                                <p>
                                ...
                                <p>
                                    ...
                                    tickets need your review and feedback before we can proceed.</p>
                                <p>
                                ...
                                <p>
                                    ...
                                    has been released on product server ,but you didn't approve.</p>
                                <p>
                    ...
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                7. Can I cancel tickets once they’ve been entered into the portal?</div>
                            <div class="faqsText" id="div8">
                                ...
                                be able to access it again.</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                8. Can I cancel once my ticket is ‘In Progress?’</div>
                            <div class="faqsText" id="div9">
                                Yes, you can still cancel you ticket once it’s in progress but please note that
                                you will still be financially responsible for what has already been worked on.</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                9. Why do I need an emergency contact?</div>
                            <div class="faqsText" id="div10">
                                We suggest including an emergency contact in case we need to contact your regarding
                                an urgent ticket matter and you are unavailable.</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                10. What is an IT consulting agreement?</div>
                    ...
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                11. How do I know if my company has a maintenance plan?</div>
                    ...
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                12. How do I know if my company requires a quote approval?</div>
                            <div class="faqsText" id="div13">
                                <ul>
                                    <li>Selecting ‘Needs a quote approval’ requires you to approve any ticket submitted
                                        ...
                                        on your ticket</li><li>Selecting ‘Does not need a quote approval’ allows us to immediately
                                            work on all tickets as soon as they are submitted within the client portal</li></ul>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                13. Why do I need to use the client portal to submit my requests?</div>
                    ...
                    <tr>
                        <td class="faqsBottom">
                            ...
                            <div class="faqsText" id="div15">
                                ...
                                Lower priority tickets will be worked on after urgent tickets are completed.</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                15. How will I know the status of my request?</div>
                            <div class="faqsText" id="div16">
                                You can track the status of your request in real time by going to the ‘View Ticket
                                Progress’ page and locating the status column.</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                16. How can I change my password?</div>
                            <div class="faqsText" id="div17">
                                To change your password, simply go to ‘My Account’ and select ‘Change Password.’
                                You will be prompted to input a new password</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                17. What is the Survey option?</div>
                    ...
                    <tr>
                        <td class="faqsBottom">
                            <div class="faqsTitle">
                                18. Who can I contact if I have an emergency request?</div>
