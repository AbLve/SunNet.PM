<%@ Page Title="Add Ticket" Language="C#" MasterPageFile="~/Sunnet/InputPop.Master"
    ValidateRequest="false" AutoEventWireup="true" CodeBehind="AddTicket.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Clients.AddTicket" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(window).on('beforeunload', function () {
            ...
            if ((hasChangeForm && isSubmit && $('#closePopWindow').attr('clicked') == '1') || (hasChangeForm && !isValidated)) {
                return '';
            }
        });
    </script>
    ...
    <div class="owmainBox">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlProject" runat="server" CssClass="select635"  Width="635">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:DropDownList ID="ddlTicketType" runat="server" Width="78">
                        <asp:ListItem Text="Bug" Selected="True" Value="0"> </asp:ListItem>
                        ...
                        <asp:ListItem Text="Change" Value="4"> </asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input id="txtTitle" runat="server" type="text" class="input630" maxlength="99" />
                </td>
            </tr>
            <tr>
                <th>URL:
