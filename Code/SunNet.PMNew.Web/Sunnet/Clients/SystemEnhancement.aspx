<%@ Page Title="SunNet PM System Enhancemen" Language="C#" MasterPageFile="~/Sunnet/Main.Master"
    AutoEventWireup="true" CodeBehind="SystemEnhancement.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Clients.SystemEnhancement" %>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlProject" runat="server" CssClass="select635" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlProject_SelectedIndexChanged" Width="635">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
