<%@ Page Title="Submit an Issue" Language="C#" MasterPageFile="~/Sunnet/Main.Master" AutoEventWireup="true"
   ValidateRequest="false"  CodeBehind="AddIssue.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Clients.AddIssue" %>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:DropDownList runat="server" ID="ddlType" Width="78">
                        ...
                        <asp:ListItem Text="Issue" Selected="True" Value="3"> </asp:ListItem>
