...
{
    public partial class AddRequest : BaseWebsitePage
    {
        ...
        private void SaveTicket(int save)
        {
            ...
            switch (save)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    ShowMessageAndRedirect("The ticket has been added.", "/sunnet/Clients/AddRequest.aspx");
                    break;
            }
        }
        ...
        protected void ddlProject_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (project > 0)
            {
                ...
                chkEN.Checked = projectEntity.RequestNeedApproved;
            }
        }
