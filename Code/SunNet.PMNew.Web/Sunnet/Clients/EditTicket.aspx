<%@ Page Title="Edit Ticket" Language="C#" MasterPageFile="~/Sunnet/InputPop.Master" ValidateRequest="false"
    AutoEventWireup="true" CodeBehind="EditTicket.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Clients.EditTicket" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="btnBoxone">
        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btnone" OnClick="btnSave_Click"
