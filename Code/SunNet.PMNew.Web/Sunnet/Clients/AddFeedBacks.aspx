<%@ Page Title="Add Note" Language="C#" MasterPageFile="~/Sunnet/InputPop.Master"
    AutoEventWireup="true" CodeBehind="AddFeedBacks.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Clients.AddFeedBacks" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="btnBoxone">
        ...
        <input type="button" class="btnfive" value="Clear" onclick="return btnclear();" />
    </div>
