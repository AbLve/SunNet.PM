<%@ Page Title="Cancelled Tickets" Language="C#" MasterPageFile="~/Sunnet/Main.Master"
    AutoEventWireup="true" CodeBehind="ListTicketCancel.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Clients.ListTicketCancel" %>
    ...
    <div class="mainrightBoxtwo">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="listtwo">
            ...
            <asp:Repeater ID="rptTicketsList" runat="server">
                <ItemTemplate>
                    <tr opentype="popwindow" dialogwidth="830" dialogheight="645" dialogtitle="" href="/Sunnet/Clients/ViewRelatedTicket.aspx?tid=<%#Eval("TicketID") %>"
