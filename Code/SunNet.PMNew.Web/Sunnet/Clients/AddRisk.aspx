<%@ Page Title="Submit a Risk" Language="C#" MasterPageFile="~/Sunnet/Main.Master" AutoEventWireup="true"
  ValidateRequest="false"   CodeBehind="AddRisk.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Clients.AddRisk" %>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:DropDownList runat="server" ID="ddlType" Width="78">
                        ...
                        <asp:ListItem Text="Risk" Selected="True" Value="2"> </asp:ListItem>
