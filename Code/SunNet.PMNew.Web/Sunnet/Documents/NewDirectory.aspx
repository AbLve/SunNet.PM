<%@ Page Title="New Directory | Upload File" Language="C#" MasterPageFile="~/Sunnet/InputPop.Master"
    AutoEventWireup="true" CodeBehind="NewDirectory.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Documents.NewDirectory" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="server">
    New Directory | Upload File
</asp:Content>
    ...
    <div class="owmainBox">
        <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="opendivTable">
            <tr>
                ...
                <td width="*">
                    <asp:RadioButton ID="rbtnNewDirectory" Checked="true" GroupName="action" Text="New Directory"
                        runat="server" />
                    <asp:RadioButton ID="rbtnNewFile" Text="Upload File" runat="server" GroupName="action" />
                </td>
            </tr>
            <tr>
                <th>
