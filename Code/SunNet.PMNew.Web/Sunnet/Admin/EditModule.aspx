<%@ Page Title="Edit Module" Language="C#" MasterPageFile="~/Sunnet/InputPop.Master"
    AutoEventWireup="true" CodeBehind="EditModule.aspx.cs" Inherits="SunNet.PMNew.Web.Sunnet.Admin.EditModule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="owToptwo">
        <img src="/icons/19.gif" align="absmiddle" alt="Basic Information" />
    ...
    <div class="owmainBox">
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
            ...
            <tr>
                <th>
                    Show In Menu:<span class="redstar">*</span>
                </th>
                <td>
        ...
        <div class="btnBoxone">
            <asp:Button ID="btnSave" CssClass="btnone" OnClientClick="return Validate();" runat="server"
