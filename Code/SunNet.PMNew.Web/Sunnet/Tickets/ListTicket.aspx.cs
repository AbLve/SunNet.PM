    ...
    public partial class ListTicket : BaseWebsitePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    ddlAssUser.SelectedValue = this.UserInfo.UserID.ToString();
                    ddlAssUser.Enabled = false;
        ...
        private void TicketsDataBind()
        {
            ...
            DTO.AssignedUser = ValidateDDLIsFirstIndexReturnEmpty(ddlAssUser, true);
            DTO.Client = "";
        ...
        private void InitInternalUserBind()
        {
            ...
            ddlAssUser.DataTextField = "FirstName";
            ddlAssUser.DataValueField = "UserID";

            ddlAssUser.DataSource = response.ResultList.FindAll(x => x.Role != RolesEnum.CLIENT);
            ddlAssUser.DataBind();
            ddlAssUser.Items.Insert(0, new ListItem("Please select...", ""));
        }
